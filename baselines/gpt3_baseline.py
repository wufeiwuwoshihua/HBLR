...
class GPT3_Reasoning_Graph_Baseline:
    ...
    def reasoning_graph_generation(self):
        ...
        for example in tqdm(raw_dataset):
            ...
            output = LLM_response_self(full_prompt, self.model)
            
            # print("output from openai: ", output)
...
def parse_args():
    ...
    parser.add_argument('--save_path', type=str, default='/home/Jundong0526/Logic-LLM/results')
